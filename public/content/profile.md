...
<a style="color: var(--ctp-subtext0);" href="https://github.com/zy-ning">[nf-fa-github] zy-ning</a> <span style="width: 0.5rem; display: inline-block;"></span>
<a style="color: var(--ctp-subtext0);" href="https://www.linkedin.com/in/zhiyuan-ning">[nf-fa-linkedin] zhiyuan-ning</a> <br/>
[nf-fa-phone] +86 18034762891 -->
...
**High School Diploma** | Sep 2019 - Jul 2022
- Second Prize in the Chinese Physics Olympiad (CPhO)

### Internships

#### Multimodal AI Research Intern
**The Institute of Artificial Intelligence, China Telecom (TeleAI)** | *Shanghai, China* | Jan 2025 - Aug 2025
- Researched efficient acceleration and compression algorithms for LLMs and MLLMs, focusing on hardware-constrained system-level optimization.
- Designed and implemented an efficient quantization framework with mixed-precision and rounding optimization for visual instruction performance.
- Proposed a novel **Cascade Self-Speculative Decoding (CAS-Spec)** algorithm for on-the-fly lossless acceleration on edge and cloud devices.
